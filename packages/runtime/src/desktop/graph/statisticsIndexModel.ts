...
import { appendDesktopDiagnostic, appendDesktopDiagnostics, desktopDiagnostic, errorMessage } from "./desktopDiagnostics.js";
...
export function buildStatisticsProjectionFromIndexes(
  ...
  return { statistics: mergeStatisticsParts(parts), diagnostics };
}
