...
export function RightPaletteSidebar({
  ...
  return (
    <aside
      ...
      className="relative flex shrink-0 flex-col overflow-hidden border-l border-border/80 bg-app-panel text-text transition-[width,opacity,border-color] duration-[var(--motion-duration-panel)] ease-[var(--motion-ease-emphasized)]"
      style={{ width: rightSidebarCollapsed ? 0 : width, opacity: rightSidebarCollapsed ? 0 : 1, borderLeftColor: rightSidebarCollapsed ? "transparent" : undefined }}
    >
...
export function CollapsedSidebarControls({
  ...
  return (
    <>
      {leftSidebarCollapsed ? (
        <div className="app-drag-region absolute left-0 top-0 z-20 flex h-11 w-[280px] items-center border-b border-border/80 bg-app-topbar px-3 pl-[124px] text-text animate-in fade-in slide-in-from-left-2 duration-[var(--motion-duration-panel)] ease-[var(--motion-ease-standard)]">
      ...
      {rightSidebarCollapsed ? (
        <div className="app-drag-region absolute right-0 top-0 z-30 flex h-11 w-11 items-center justify-center border-b border-l border-border/80 bg-app-topbar text-text animate-in fade-in slide-in-from-right-2 duration-[var(--motion-duration-panel)] ease-[var(--motion-ease-standard)]">
